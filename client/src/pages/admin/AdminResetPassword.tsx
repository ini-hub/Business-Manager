        ...
        <div className="bg-card backdrop-blur-md border border-border rounded-3xl p-8 shadow-2xl animate-in fade-in zoom-in-95 duration-500">
          {success ? (
            <div className="text-center space-y-4">
              ...
              <p className="text-sm text-muted-foreground">You can now sign in to the Super Admin Console with your new password.</p>
              <Button
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="space-y-1">
                <Label htmlFor="otp" className="text-xs font-semibold uppercase tracking-wider text-muted-foreground block text-center">
                  6-Digit Reset Code
                </Label>
                <Input
                  id="otp"
                  ...
                  maxLength={6}
                  placeholder="000000"
                  className="transition-all rounded-xl py-6 text-center font-mono text-2xl tracking-[0.4em] pl-6"
                  value={otp}
              ...
              <Link href="/super-admin/forgot-password" className="flex items-center justify-center gap-2 text-xs text-muted-foreground hover:text-foreground transition-colors">
